...
void sppm_camera_pass(SPPM *sppm, PixelData *pixel_datas) {
    ...
    for(i = 0, width_tracker = 8; i < pixel_datas->size_float_simd; i += NUM_FLOAT_SIMD) {
        ...
        if(width_tracker < 8 && width_tracker != 0){
            switch (width_tracker) {
                case 1: {
                    ...
                    x = _mm256_blend_ps(x, t1, 0b01111111);
                    break;}
                case 2: {
                    ...
                    x = _mm256_blend_ps(x, t1, 0b00111111);
                    break;}
                case 3: {
                    ...
                    x = _mm256_blend_ps(x, t1, 0b00011111);
                    break;}
                case 4: {
                    ...
                    x = _mm256_blend_ps(x, t1, 0b00001111);
                    break;}
                case 5: {
                    ...
                    x = _mm256_blend_ps(x, t1, 0b0000111);
                    break;}
                case 6: {
                    ...
                    x = _mm256_blend_ps(x, t1, 0b0000011);
                    break;}
                case 7: {
                    ...
                    x = _mm256_blend_ps(x, t1, 0b0000001);
                    break;}
            }
        }
            ...
            if (c_depth > 0) {
                ...
                for (int j = 0; j < NUM_FLOAT_SIMD; j++) {
                    ...
                    for (cur_arr_ind = 0; cur_arr_ind < (lookup->hash_table[ht_loc_impl[j]].size / NUM_FLOAT_SIMD) * NUM_FLOAT_SIMD; cur_arr_ind += NUM_FLOAT_SIMD) {
                        ...
                        cmp0 = _mm256_and_ps(cmp0, not_completion_vector);
...
//                      conscious choice to not store cur_vp_intersection->wo, since it is not needed
                        ...
                        __m256 bsdf_x_times_rad = _mm256_mul_ps(bsdf_x, light_radiance_x);
